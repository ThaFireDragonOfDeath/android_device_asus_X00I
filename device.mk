...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_qrd_skuk.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_skuk.xml \
    $(LOCAL_PATH)/audio/mixer_paths_qrd_wcd9306.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_wcd9306.xml \
    $(LOCAL_PATH)/audio/mixer_paths_qrd_wcd9326.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_wcd9326.xml \
    $(LOCAL_PATH)/audio/mixer_paths_qrd_wcd9330.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_wcd9330.xml \
    $(LOCAL_PATH)/audio/mixer_paths_qrd_wcd9335.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_wcd9335.xml
